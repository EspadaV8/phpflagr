...
class PutSegmentRequest implements ModelInterface, ArrayAccess
{
    ...
    public function setRolloutPercent($rolloutPercent)
    {
        ...
        if (($rolloutPercent > 100)) {
            throw new \InvalidArgumentException('invalid value for $rolloutPercent when calling PutSegmentRequest., must be smaller than or equal to 100.');
        }
        if (($rolloutPercent < 0)) {
            throw new \InvalidArgumentException('invalid value for $rolloutPercent when calling PutSegmentRequest., must be bigger than or equal to 0.');
        }

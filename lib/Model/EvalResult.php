...
class EvalResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'evalContext' => '\EspadaV8\PHPFlagr\Model\EvalContext',
        'timestamp' => 'string',
        'evalDebugLog' => '\EspadaV8\PHPFlagr\Model\EvalDebugLog'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['segmentID'] < 1)) {
            $invalidProperties[] = "invalid value for 'segmentID', must be bigger than or equal to 1.";
        }
        ...
        if ($this->container['variantAttachment'] === null) {
            $invalidProperties[] = "'variantAttachment' can't be null";
        }
        if ($this->container['evalContext'] === null) {
            $invalidProperties[] = "'evalContext' can't be null";
        }
    ...
    public function setFlagID($flagID)
    {
        ...
        if (($flagID < 1)) {
            throw new \InvalidArgumentException('invalid value for $flagID when calling EvalResult., must be bigger than or equal to 1.');
        }
    ...
    public function setSegmentID($segmentID)
    {
        ...
        if (($segmentID < 1)) {
            throw new \InvalidArgumentException('invalid value for $segmentID when calling EvalResult., must be bigger than or equal to 1.');
        }
    ...
    public function setVariantID($variantID)
    {
        ...
        if (($variantID < 1)) {
            throw new \InvalidArgumentException('invalid value for $variantID when calling EvalResult., must be bigger than or equal to 1.');
        }
    ...
    public function setVariantKey($variantKey)
    {
        ...
        if ((mb_strlen($variantKey) < 1)) {
            throw new \InvalidArgumentException('invalid length for $variantKey when calling EvalResult., must be bigger than or equal to 1.');
        }
     ...
     * Gets evalContext
     *
     * @return \EspadaV8\PHPFlagr\Model\EvalContext
     */
     ...
     * Sets evalContext
     *
     * @param \EspadaV8\PHPFlagr\Model\EvalContext $evalContext evalContext
     *
     * @return $this
     */
     ...
     * Gets evalDebugLog
     *
     * @return \EspadaV8\PHPFlagr\Model\EvalDebugLog
     */
     ...
     * Sets evalDebugLog
     *
     * @param \EspadaV8\PHPFlagr\Model\EvalDebugLog $evalDebugLog evalDebugLog
     *
     * @return $this
     */

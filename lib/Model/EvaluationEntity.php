...
class EvaluationEntity implements ModelInterface, ArrayAccess
{
    ...
    public function setEntityID($entityID)
    {
        ...
        if ((mb_strlen($entityID) < 1)) {
            throw new \InvalidArgumentException('invalid length for $entityID when calling EvaluationEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setEntityType($entityType)
    {
        ...
        if ((mb_strlen($entityType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $entityType when calling EvaluationEntity., must be bigger than or equal to 1.');
        }

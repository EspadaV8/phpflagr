...
class EvaluationApi
{
     ...
     *
     * @param  \EspadaV8\PHPFlagr\Model\EvalContext $body evalution context (required)
     *
     ...
     * @throws \EspadaV8\PHPFlagr\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EspadaV8\PHPFlagr\Model\EvalResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function postEvaluationWithHttpInfo($body)
    {
        $returnType = '\EspadaV8\PHPFlagr\Model\EvalResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EspadaV8\PHPFlagr\Model\EvalResult',
     ...
     *
     * @param  \EspadaV8\PHPFlagr\Model\EvaluationBatchRequest $body evalution batch request (required)
     *
     * @throws \EspadaV8\PHPFlagr\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EspadaV8\PHPFlagr\Model\EvaluationBatchResponse
     */
     ...
     * @throws \EspadaV8\PHPFlagr\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EspadaV8\PHPFlagr\Model\EvaluationBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postEvaluationBatchWithHttpInfo($body)
    {
        $returnType = '\EspadaV8\PHPFlagr\Model\EvaluationBatchResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EspadaV8\PHPFlagr\Model\EvaluationBatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
